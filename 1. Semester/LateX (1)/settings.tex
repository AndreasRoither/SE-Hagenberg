...
\newcommand{\conj}[1]{\underbrace{#1}_{Konjunktion}}
\newcommand{\disj}[1]{\underbrace{#1}_{Disjunktion}}
\newcommand{\impl}[1]{\underbrace{#1}_{Implikation}}
\newcommand{\nega}[1]{\underbrace{#1}_{Negation}}